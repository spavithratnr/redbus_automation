...
public class BookTwoTest extends BusBaseTest{
	...
	public void enterSameFromDestDate(String from, String dest, String date, String expectedResult)
			throws InterruptedException, ParseException{
		HomePage homePage = new HomePage(driver);
		test = extent.createTest("Enter same sourcr and destination");
		...
		try {
			if (!from.equals(listPage.nearestDestinationWebElement().getAttribute("title"))) {
	...
	public Object[][] getFields() {
		...
		Object[][] data = { { "Koyambedu, Chennai", "Koyambedu, Chennai", "15-Aug-2022", "Success" } };
